...
/* Hacked albhabet sort  End */
    ...
    },
    {
		...
		'distanceErrorAlert'       : 'Siamo spiacenti, il medico TEOSYAL®PEN più vicino a te dista più di ',
		'mileLang'                 : 'mile',
		'milesLang'                : 'miles',
		'kilometerLang'            : 'km',
		'kilometersLang'           : 'KM',
	...
	$.extend(Plugin.prototype, {
		...
		/* Hacked albhabet sort */
		  sortNumerically: function (locationsarray) {
            this.writeDebug('sortNumerically', arguments);
            var sorto = {
                distance: "asc", name: "asc"
            };
            locationsarray.keySort(sorto);
