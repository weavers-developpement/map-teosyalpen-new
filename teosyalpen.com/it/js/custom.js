  ...
  if (isMobile.matches) {
      $('#fullpage').fullpage ({
        ...
        menu: '#navSlide',
          ...
          anchors: ['home', 'naturale','trattamento','trova','medias','teoxane'],
        autoScrolling: true,
          scrollBar: false,
        css3: false,
   ...
   $rightControl.addClass('slideOnecontrol')
	...
	// if the last slide,
		if (!$active.next().length) {
			...
			$leftControl.find('.frSlideTxt').append('<div class="preview txt3">Trattamento iniettivo in dolcezza</div>');
      ...
      sessionStorage.setItem('sliderindex', 3);
		// if not,
			...
			$rightControl.find('.frSlideTxt').append('<div class="preview txt3 txt33">Uno strumento di precisione...</div>');
			$leftControl.find('.enSlideTxt').append('<div class="preview txt2">the first system</div>');
			$leftControl.find('.frSlideTxt').append('<div class="preview txt2">Il primo device...</div>');
      ...
      sessionStorage.setItem('sliderindex', 1);
			...
			$rightControl.find('.frSlideTxt').append('<div class="preview txt1">Trattamento iniettivo in dolcezza</div>');
