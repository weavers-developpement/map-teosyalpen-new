<?php
    ...
    define('DOWNSIZE_NOT_FOUND', false);     // If a regular image is requested and not found, send a retina file instead?
    define('CACHE_TIME',         24*60*60*7); // default: 1 day / j'ai mis 7 jour 
