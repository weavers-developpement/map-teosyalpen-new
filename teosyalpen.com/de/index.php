...
<html lang="de">
  <head>
    ...
    <article class="innerContent" id="homeContent">
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-4 nopad">
						<div class="innerTxt">
							<h1>Warum leiden,<span> um schön zu sein?</span></h1>
							<p>Haben Sie Interesse an Hyaluronsäure-Injektionen, fürchten aber Schmerzen oder eine allzu lange Genesungszeit?</p>
							<p>Sie müssen nicht leiden, um schön zu sein: Dank dem TEOSYAL<sup>®</sup>PEN sind <span class="innerTxtclr"> sanfte Injektionen möglich.<sup>1</sup></p>
							 <a class="btn btn-primary contentBtn" href="#trova" role="button">Arztsuche<i class="fa fa-map-marker"></i></a> 
						</div>
					</div>
		...
		<div class="arrow_scroll">
			<div class="iconArrow" data-menuanchor="natural"><!--<a href="#natural">--><i class="fa fa-angle-down"></i><span>Runterscrollen</span></a></div>
  ...
  <article class="innerContent" id="naturalPageContent">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-4">
          <div class="innerTxt">
            <h1>Was sind <span> Hyaluronsäure-Injektionen?</span></h1>
            <p>Hyaluronsäure ist ein <span class="innerTxtclr">essenzieller Hautbestandteil.</span> Sie verhält sich wie ein Schwamm, der Wasser in sich aufnimmt und <span class="innerTxtclr">die Haut feucht, straff und gesund hält.</span></p>
            <p>Im Alter von zwischen 40 und 50 Jahren verlieren wir 50% unserer Hyaluronsäure-Vorräte.<sup>2</sup> Dadurch wird die Haut trocken, dünn und weniger widerstandsfähig.</p>
            <p>Um die Anzeichen des Alterns zu verringern, können Hyaluronsäure-Gels in die Haut injiziert werden, die dort <span class="innerTxtclr">als Füllstoff oder “Beauty-Booster” wirken</span>.</p>

            <a class="btn btn-primary contentBtn" href="http://www.teoxane.com/de/meine-erste-injektion" role="button" target="_blank">Meine erste Injektion<i class="iconsprite injectionicon"></i></a>
          </div>
        </div>
    ...
    <div class="footerTxt">
        <ul>
          <li><sup>2</sup>Observatoire des Cosmétiques, Oktober 2010.</li>
		...
		<div class="container-fluid nopad ">
            ...
            <div class="row-fluid">
  						...
  						<div class="col-xs-12 col-sm-5 col-md-4  slideContentHeight slideContentHeight1">
  							...
  							<h1><span class="hide1">Das erste drahtlose, motorisierte System</span> für Hyaluronsäure-Injektionen</h1>
  							<p>Ein <span class="innerTxtclr">natürliches Ergebnis,</span> das <span class="innerTxtclr"> Fehlen direkter Nebenwirkungen </span>und<span class="innerTxtclr"> weniger Schmerzen bei der Behandlung </span> sind für Sie die entscheidenden Kriterien, bevor Sie sich mit Injektionen behandeln lassen.<sup>1</sup></p>
  							<p>Der TEOSYAL<sup>®</sup>PEN  wurde speziell  <span class="innerTxtclr">für Sie und den anwendenden Arzt</span> entwickelt, der mit seinen Auffüllinjektionen eine neue Ebene seines ärztlichen Könnens erreichen möchte. Der TEOSYAL<sup>®</sup>PEN  ist ein einzigartiges elektronisches Gerät, das <span class="innerTxtclr">eigens für Hyaluronsäure-Injektionen konzipiert </span>wurde. </p>
  							</div>
  							<div class="footerTxt footerTxt1">
  								<ul>
                    <li><sup>1 </sup> Kantar Health. Das europäische Prüfverfahren für den TEOSYAL<sup>®</sup>PEN umfasste 30 Ärzte und 236 Patienten, von denen 42 zuvor noch keine manuellen Injektionen mit hyaluronsäurebasierten Füllern erhalten hatten. Bericht Nr. 40HB64, 2014. „Natürliches Ergebnis“, „Fehlen von Nebenwirkungen“ und „weniger Schmerzen“ sind qualitative Kriterien, die anhand einer Skala von 0 (unwichtig) bis 5 (sehr wichtig) erfasst wurden. Die hier genannten Kriterien wurden als „wichtig“ (4) oder „sehr wichtig“ (5) bewertet.</li>
    								<li>Der TEOSYAL<sup>®</sup>PEN ist ein nichtsteriles Gerät, das dafür bestimmt ist, Medizinern das Injizieren von Dermalfüllern zu erleichtern. Der anwendende Arzt ist dazu verpflichtet, die Hinweise zur Anwendung zur Kenntnis zu nehmen und zu befolgen, um Nebenwirkungen und Beschwerden zu vermeiden. Weitere Informationen entnehmen Sie bitte dem Benutzerleitfaden auf dieser Website. Wenn Sie selbst Patient sind, dann wenden Sie sich bitte auch an Ihren Arzt, um mehr Einzelheiten zu Ihrer Behandlung zu erfahren. Der TEOSYAL<sup>®</sup>PEN ist ein medizinisches Gerät der Klasse IIa (CE-Kennzeichnung 0434). Bei der Behandlung mit Füllerprodukten können im Laufe der Zeit mehrere Wiederanwendungen erforderlich werden, um das gewünschte Ergebnis zu erzielen. Hergestellt in der Schweiz von JuvaPlus. </li>
  							  </ul>
  							</div>
  						</div>
            ...
            <div class="row-fluid">
						<div class="col-xs-12 col-sm-5 col-md-5 marginOffetleftTxt slideContentHeight slideContentHeight2">
							<div class="innerTxt sliderBarContent sliderTxt2" id="indicator-container">
								<h1 class="slideheader2"><span>Sanfte </span>Injektion</h1>
								<div class="row">
								   <div class="col-xs-12 col-sm-8 col-md-4 vcenter">
									<div class="indicator">
											<div class="outer2">
												<div class="inner inner2" id="inner1" data-to="70" data-speed="1000">70</div>
												<div class="title">der Patienten</div>
											</div>
										</div>
								  </div>
								   <div class="col-xs-12 col-sm-12 col-md-7 vcenter colLeftPadnone">
									<p class="progressTxt">70% der Patienten <span class="innerTxtclr"> bewerteten die Schmerzintensität zwischen 0 oder 1 </span>während der Injektion mit dem TEOSYAL<sup>®</sup>PEN  gegenüber 18% Injektionen mit der Hand<sup>1</sup></span></p>
								  </div>
								</div>
								  ...
								  <div class="col-xs-12 col-sm-8 col-md-4 vcenter">
									<div class="indicator">
											...
											<div class="inner22 innerImg"></div>
												<div class="title headTxt">Schnellere<span>Erholung</span> </div>
									...
									<p class="progressTxt">Anschließend können Sie <span class="innerTxtclr">rasch Ihren normalen Aktivitäten nachgehen, </span>wie beispielsweise am gleichen Tag an den Arbeitsplatz zurückzukehren.</p>
								...
								<div class="row padtop75 clearfix">
								    ...
								    <div class="col-xs-12 col-sm-12 col-md-7 vcenter colLeftPadnone">
                                    <p class="progressTxt">9 von 10 Patienten (90,6%) würden ihre nächste Behandlung <span class="innerTxtclr"> lieber mit dem TEOSYAL<sup>®</sup>PEN </span>als durch eine manuelle Injektion erhalten.<sup>1</sup></p>

									<p class="progressTxt">9 von 10 Patienten (91,7%) würden Freunden den <span class="innerTxtclr">TEOSYAL<sup>®</sup>PEN</span> anstelle einer manuellen Injektion empfehlen.<sup>1</sup></p>
								  </div>
								</div>
								...
								<div class="footerTxt footerTxt2">
									<ul>
  										<li><sup>1</sup>Kantar Health. Das europäische Prüfverfahren für den TEOSYAL<sup>®</sup>PEN umfasste 30 Ärzte und 236 Patienten, von denen 42 zuvor noch keine manuellen Injektionen mit hyaluronsäurebasierten Füllern erhalten hatten. Bericht Nr. 40HB64, 2014.Die Schmerzintensität durch die Patienten auf einer Skala von 0 (kein Schmerz) bis 5 (erhebliche Schmerzen) beurteilt </li>
									</ul>
								</div>
						</div>
            ...
            <div class="row-fluid">
  						...
  						<div class="innerTxt sliderTxt3">
  							<h1>Ein Präzisionswerkzeug <span>im Dienste Ihrer Schönheit</span></h1>
  							<p><span class="innerTxtclr">Der TEOSYAL<sup>®</sup>PEN</span> erlaubt es Ihrem Behandler seine Kunst zum Leben zu erwecken. Da alles elektronisch gesteuert wird, kann sich der Behandler voll auf die Applikation des Gels konzentrieren. </p>
                <p>Durch die Verwendung des motorisierten Injektionssytems wird das Gel <span class="innerTxtclr"> langsam und gleichmäßig </span> abgegeben.</p>
                <p>Der TEOSYAL<sup>®</sup>PEN ist auch besonders für <span class="innerTxtclr">empfindliche Regionen geeignet, indem er neue Möglichkeiten für Ihr Schönheitsmanagement eröffnet.</span></p>
  						<p>"Warum würden Sie den TEOSYAL<sup>®</sup>PEN Ihren Freunden empfehlen?"<sup>1</sup></p>
  							<ul class="arrowTxt">
    							<li>"Gute Ergebnisse, weniger Spuren"</li>
    							<li>"Natürliche Ergebnisse und weniger Schmerzen"</li>
    							<li>"Weniger Nebenwirkungen"</li>
                  <li>"Weniger Blutungen"</li>
  							</ul>

  							</div>
  							<div class="footerTxt footerTxt3">
  							<ul>
  								<li><sup>1</sup> Kantar Health. Das europäische Prüfverfahren für den TEOSYAL<sup>®</sup>PEN umfasste 30 Ärzte und 236 Patienten, von denen 42 zuvor noch keine manuellen Injektionen mit hyaluronsäurebasierten Füllern erhalten hatten. Bericht Nr. 40HB64, 2014. </li>
  							</ul>
  							</div>
  						</div>
  						<div class="col-xs-12 col-sm-6 col-md-6  col-md-offset-1 slideimgheight slideimgheight3 marginOffetrightImg">
  							<div class="slideimgwrap">
  								<div class="slideimg3 slideimg3_gr"></div>
  							</div>
  						</div>
  					</div>
				</div>
			  ...
			  <a class="right carousel-control slideTxt1" href="#carousel-example-generic" role="button" data-slide="next">
				...
				<div class="preview txt1">Sanfte Injektion</div>
				</div>
			  </a>
			</div>
			</div>
	...
	<!-- Header Section -->
	   ...
	   <section id="doctorsPageContent" class="innerContent">
		  <div class="container">
            ...
            <h1>FINDEN SIE EINEN ARZT IN IHRER NÄHE, DER DEN  TEOSYAL<sup>®</sup>PEN  VERWENDET. <img src="images/plusminus.png" id="plus" /></h1>
						<div class="innerForm">
							<form id="bh-sl-user-location" method="post" action="#">
								<div class="input-group stylish-input-group">
								    <input type="text" class="form-control" id="bh-sl-address" name="bh-sl-address" placeholder="Adresse, Stadt, PLZ ..." value="" >
                ...
                <div class="row-fluid nopad teoxaneTop">
                    <div class="col-md-12 col-sm-12 nopad">
                        <div class="teoxane-image">
                           ...
                           <a href="http://www.teoxane.com/de" target="_blank"> <div class="lab-teoxane img-responsive imgCenter teo-img-logo"></div></a>
                ...
                <div class="row-fluid nopad teoxaneMiddle">
                    <div class="col-md-12 col-sm-12 nopad">
                        <div class="teoxane-image1">
                           ...
                           <a href="http://www.teoxane-cosmetic.de/" target="_blank"> <div class="lab-teoxane1 img-responsive imgCenter teo-img-logo1"></div></a>
                        </div>
                    </div>
                </div>
                </div>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4">
							...
							<ul>                                
                                ...
                                <li><a class="language active" href="#" rel="de">DEUTSCH</a></li>
...
Fax: (0041) 21 964 17 91
	...
	<nav class="navWrap" id="navSlide">
		<div class="menuIconWrap">
			<div class="langTxt" data-toggle="modal" data-target="#myModal">DE</div>
			<div class="menuIcon">
        <ul>
					<li data-menuanchor="home"><a href="#home"><i class="iconsprite homeicon hovericon"></i><span>MENÜ</span></a></li>
					<li data-menuanchor="naturale"><a href="#naturale"><i class="iconsprite naturalicon"></i><span>NATÜRLICH</span></a></li>
					<li data-menuanchor="trattamento"><a href="#trattamento"><i class="iconsprite smoothicon"></i><span>SANFTE INJEKTION</span></a></li>
					<li data-menuanchor="trova"><a href="#trova"><i class="iconsprite mydoctoricon"></i><span>ANWENDERSUCHE</span></a></li>
					<li data-menuanchor="medias"><a href="#medias"><i class="iconsprite mediaicon"></i><span>MEDIA</span></a></li>
 ...
 <!-- jQuery -->
    ...
    <script src="http://maps.google.com/maps/api/js?v=3.21&sensor=false&libraries=places&language=de"></script>
