   ...
   $rightControl.addClass('slideOnecontrol')
	...
	// if the last slide,
		if (!$active.next().length) {
			...
			$leftControl.find('.frSlideTxt').append('<div class="preview txt3">Sanfte Injektion</div>');
      ...
      sessionStorage.setItem('sliderindex', 3);
		// if not,
			...
			$rightControl.find('.frSlideTxt').append('<div class="preview txt3 txt33">Ein exaktes Intsrument...</div>');
			$leftControl.find('.enSlideTxt').append('<div class="preview txt2">the first system</div>');
			$leftControl.find('.frSlideTxt').append('<div class="preview txt2">Das erste System...</div>');
      ...
      sessionStorage.setItem('sliderindex', 1);
			...
			$rightControl.find('.frSlideTxt').append('<div class="preview txt1">Sanfte Injektion</div>');
