...
;(function ($, window, document, undefined) {
    ...
    },
    {
		...
		'infowindowTemplatePath'   : '<?php echo get_template_directory_uri(); ?>/assets/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'         : '<?php echo get_template_directory_uri(); ?>/assets/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath': '<?php echo get_template_directory_uri(); ?>/assets/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'      : '<?php echo get_template_directory_uri(); ?>/assets/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'           : null,
		...
		'distanceErrorAlert'       : 'Malheureusement, notre spÃ©cialiste TEOSYALÂ®PEN le plus proche est Ã  plus de ',
		'mileLang'                 : 'mile',
		'milesLang'                : 'miles',
		'kilometerLang'            : 'km',
		'kilometersLang'           : 'KM',
