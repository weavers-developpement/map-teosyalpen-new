...
(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        'listTemplatePath': 'assets/js/plugins/storeLocator/templates/location-list-description.php',
        ...
        'distanceErrorAlert': 'Malheureusement, notre spécialiste TEOSYALPEN le plus proche est à  plus de ',
        'mileLang': 'mile',
        'milesLang': 'miles',
        'kilometerLang': 'km',
        'kilometersLang': 'KM',
    ...
    $.extend(Plugin.prototype, {
        ...
        notify: function (notifyText) {
            ...
            if (this.settings.callbackNotify) {
                ...
                var clang = $('html')[0].lang.slice(0, 2),
                    notifyTextLang;
                switch (clang) {
                    case "fr":
                        notifyTextLang = notifyText;
                        break;
                    case "it":
                        notifyTextLang = notifyText.replace("Malheureusement, notre spécialiste TEOSYALPEN le plus proche est à  plus de", "Purtroppo, il nostro TEOSYALPEN specialista più vicino è finita");
                        break;
                    case "en":
                        notifyTextLang = notifyText.replace("Malheureusement, notre spécialiste TEOSYALPEN le plus proche est à  plus de", "Unfortunately, our nearest TEOSYALPEN specialist is more than");
                        break;
                    case "de":
                        notifyTextLang = notifyText.replace("Malheureusement, notre spécialiste TEOSYALPEN le plus proche est à  plus de", "Leider ist unsere nächste Spezialist TEOSYALPEN über");
                        break;
                    default:
                        notifyTextLang = notifyText.replace("Malheureusement, notre spécialiste TEOSYALPEN le plus proche est à  plus de", "Unfortunately, our nearest TEOSYALPEN specialist is more than");
                }
                ...
                //console.log(notifyTextLang);
                
                $('#notify-msg').find('.modal-body').html(notifyTextLang);
                $('#notify-msg').modal('show');
            }
        },
        ...
        _start: function () {
            ...
            if ($('#' + this.settings.addressID).val().trim() !== '') {
                ...
                doAutoGeo = true; // No need for additional processing
                //console.log(this.settings.addressID);
            }
        ...
        processData: function (mappingObject, originPoint, data, page) {
            ...
            if ((_this.settings.fullMapStart === true && firstRun === true) || (_this.settings.mapSettings.zoom === 0) || (typeof origin === 'undefined') || (distError === true)) {
                ...
                /*var latuser=google.loader.ClientLocation.latitude;
      			var lnguser=google.loader.ClientLocation.longitude;

      			console.log(google.loader.ClientLocation.address.city);
				
				var originPoint2 = new google.maps.LatLng(latuser, lnguser);
				_this.settings.mapSettings.center = originPoint2;
				_this.settings.mapSettings.zoom = 8;
				bounds = '';*/
