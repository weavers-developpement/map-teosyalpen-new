	...
	$.fn.bookingForm=function(options){
		return this.each(function(){
			...
			object = {
				...
				ownerEmail:'m.lanque@teoxane.com', // destination e-mail, message will be send on this e-mail
				...
				successMessage: "Your request has been sent! We'll be in touch soon!", // success message
				// private fields
				form: null,
				fields: [],
