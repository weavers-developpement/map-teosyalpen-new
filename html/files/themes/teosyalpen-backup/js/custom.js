 ...
 //Fullpage js and Modal scroll conflicts
  ...
  // if the last slide,
    ...
    // if not,
      ...
      $rightControl.find('.frSlideTxt').append('<div class="preview txt3 txt33"> Un dispositif de haute pr̩cision...</div>');
      $leftControl.find('.enSlideTxt').append('<div class="preview txt2">the first system</div>');
      $leftControl.find('.frSlideTxt').append('<div class="preview txt2">Le premier syst̬me...</div>');
