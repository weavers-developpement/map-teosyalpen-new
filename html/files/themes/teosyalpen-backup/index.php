...
?>
	...
	<!-- Map Section -->
	 <section id="mapSection" class="section " style="height:100%; width: calc(100% + 40px);">
		  ...
		  <div class="container">
				...
				<div class="col-xs-12 col-sm-7 col-md-5">
					<div class="mapSearchWrap" id="mapSearchWrap">
						<h1><?php echo utf8_encode(str_replace('<sup>®</sup>', '<sup>&reg;</sup>', __('Find a doctor equipped with Teosyal<sup>®</sup>Pen near you' , 'twentyeleven'))); ?> <img src="<?php echo get_template_directory_uri(); ?>/images/plusminus.png" id="plus" /></h1>
						<div class="innerForm">
							<form id="bh-sl-user-location" method="post" action="#">
								<div class="input-group stylish-input-group">
								    <input type="text" class="form-control" id="bh-sl-address" name="bh-sl-address" placeholder="<?php echo utf8_encode(str_replace('…', '...', __('Address, city, zip code…' , 'twentyeleven'))); ?>" value="" >
